...
class CustomTheme {
  ...
  //----------------  Custom PosKeeper App Color --------------//
  final Color greenLight;
  final Color greenPrimary;
  final Color appbarColor,buttonColor;
  final Color inputLevelColor,inputIconColor,placeholderTextColor,borderColor,borderFocusColor,borderErrorColor,inputTextColor,formTitleColor,titleColor;
  final Color cardHeadColor,infoFontColor,titleIconColor,menuColor,menuBackgroundColor,switchActiveColor,switchInActiveColor,iconWhiteColor,iconBlackColor;
  final Color textSmallColor,textMediumColor,textLargeColor;
  final Color nextButtonColor,previousButtonColor,checkoutButtonColor,resetButtonColor,saveButtonColor,editButtonColor,deleteButtonColor,removeButtonColor,approveButtonColor,cancelButtonColor,conformButtonColor,closeButtonColor;
  ...
  CustomTheme({
    ...
    //----------------  Custom PosKeeper App Theme --------------//
    this.greenLight =  const Color(0xff10bb6b),
    this.greenPrimary =  const Color(0xff4caf50),
    this.appbarColor=const Color(0xff4caf50),
    this.buttonColor=const Color(0xFFF4D207),
    this.approveButtonColor= const Color(0xffffffff),
    this.borderColor=const Color(0xffffffff),
    this.borderErrorColor=const Color(0xffffffff),
    this.borderFocusColor=const Color(0xffffffff),
    this.cancelButtonColor=const Color(0xffffffff),
    this.cardHeadColor=const Color(0xffffffff),
    this.checkoutButtonColor=const Color(0xffffffff),
    this.closeButtonColor=const Color(0xffffffff),
    this.conformButtonColor=const Color(0xffffffff),
    this.deleteButtonColor=const Color(0xffffffff),
    this.editButtonColor=const Color(0xffffffff),
    this.formTitleColor=const Color(0xffffffff),
    this.iconBlackColor=const Color(0xffffffff),
    this.iconWhiteColor=const Color(0xffffffff),
    this.infoFontColor=const Color(0xffffffff),
    this.inputIconColor=const Color(0xffffffff),
    this.inputLevelColor=const Color(0xffffffff),
    ...
    this.nextButtonColor=const Color(0xffffffff),
    this.placeholderTextColor=const Color(0xffffffff),
    this.previousButtonColor=const Color(0xffffffff),
    this.removeButtonColor=const Color(0xffffffff),
    this.resetButtonColor=const Color(0xffffffff),
    this.saveButtonColor=const Color(0xffffffff),
    this.switchActiveColor=const Color(0xffffffff),
    this.switchInActiveColor=const Color(0xffffffff),
    this.textLargeColor=const Color(0xffffffff),
    this.textMediumColor=const Color(0xffffffff),
    this.textSmallColor=const Color(0xffffffff),
    this.titleColor= const Color(0xffB428C3),
    this.titleIconColor= const Color(0xff387D94),
