class Images {
  ...
  static List<String> profiles = [
    ...
    'assets/images/profile/avatar_6.jpg',
  ];
  ...
  //------- Banner ------------//
  static String profileBanner = 'assets/images/profile/profile_banner.jpg';

  ///-------------------------------- Icons ---------------------------------//

  // ------- Home -----------//
  static String animationDesignIcon = 'assets/icons/animation_design.svg';
  ...
  //-------------------------------Image------------------------//
  static String img1="assets/grocery/bread.png";
  static String img2="assets/grocery/broccoli.png";
  static String img3="assets/grocery/cheese.png";
  static String img4="assets/grocery/strawberry.png";
  ...
  static List<String> portraits = [
    'assets/images/all/all-p1.jpg',
    'assets/images/all/all-p2.jpg',
    'assets/images/all/all-p3.jpg'
  ];

  static List<String> landscapes = [
    'assets/slider/all-1.jpg',
    'assets/slider/all-2.jpg',
    'assets/slider/all-3.jpg'
  ];

  static List<String> places = [
    'assets/images/place/cuba.jpg',
    'assets/images/place/london.jpg',
    'assets/images/place/paris.jpg'
  ];
  ...
  static String shoppingOrderSuccess =
      'assets/images/apps/shopping2/images/order_success.png';
  static String shoppingSplash =
      'assets/shopping/apple.png';
  static String apple = 'assets/shopping/apple.png';
  static String google = 'assets/shopping/google.png';
  static String facebook = 'assets/shopping/facebook.png';
  static String logo1='assets/shopping/illu-1.png';
  static String logo2='assets/shopping/illu-2.png';
  static String logo3='assets/shopping/illu-3.png';
  static String no_image='assets/shopping/no_image.jpg';
  static String splash='assets/splash/ic_launcher.png';
  static String shoppingProfile =
      'assets/images/apps/shopping2/images/profile.jpg';
